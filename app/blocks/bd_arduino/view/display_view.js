...
Blockly.Blocks.group_lcd_print = {
  init: function() {
    ...
    this.appendValueInput("TEXT", 'String')
		...
		.appendField(Blockly.BUDDY_DF_LCD)
		.appendField(new Blockly.FieldTextInput('mylcd'), 'VAR')
        .appendField(Blockly.BUDDY_LCD_PRINT1);
    this.appendValueInput("TEXT2", 'String')
        .setCheck(['String','Number'])
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.BUDDY_LCD_PRINT2);
	/*
	this.appendValueInput("TEXT3", String)
        .setCheck([String,Number])
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.BUDDY_LCD_PRINT3);
	this.appendValueInput("TEXT4", String)
        .setCheck([String,Number])
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.BUDDY_LCD_PRINT4);
	*/
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
...
Blockly.Blocks.group_lcd_print2 = {
  init: function() {
	...
	this.appendValueInput("row", 'Number')
		...
		.appendField(Blockly.BUDDY_DF_LCD)
		.appendField(new Blockly.FieldTextInput('mylcd'), 'VAR')
        .appendField(Blockly.BUDDY_LCD_ROW);
	this.appendValueInput("column", 'Number')
        .setCheck('Number')
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.BUDDY_LCD_COLUMN);
    this.appendValueInput("TEXT", 'String')
        .setCheck(['String','Number'])
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.BUDDY_LCD_PRINT);
    this.setPreviousStatement(true, null);
	this.setInputsInline(true);
    this.setNextStatement(true, null);
  }
...
Blockly.Blocks.group_lcd_power = {
  init: function() {
    ...
    this.appendDummyInput()
		.appendField(Blockly.BUDDY_DF_LCD)
		.appendField(new Blockly.FieldTextInput('mylcd'), 'VAR')
        .appendField(new Blockly.FieldDropdown([[Blockly.BUDDY_LCD_STAT_ON, "display"], [Blockly.BUDDY_LCD_STAT_OFF, "noDisplay"], [Blockly.BUDDY_LCD_STAT_CURSOR, "cursor"], [Blockly.BUDDY_LCD_STAT_NOCURSOR, "noCursor"], [Blockly.BUDDY_LCD_STAT_BLINK, "blink"], [Blockly.BUDDY_LCD_STAT_NOBLINK, "noBlink"], [Blockly.BUDDY_LCD_STAT_CLEAR, "clear"], [Blockly.BUDDY_LCD_NOBACKLIGHT, "noBacklight"], [Blockly.BUDDY_LCD_BACKLIGHT, "backlight"]]), "STAT");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
...
Blockly.Blocks.display_rgb_init = {
    init: function () {
        ...
        this.appendValueInput("LEDCOUNT")
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(Blockly.BUDDY_RGB_COUNT);
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setTooltip('');
...
Blockly.Blocks.display_rgb = {
    init: function () {
        ...
        this.appendValueInput("_LED_")
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(Blockly.BUDDY_RGB_NUM);
        this.appendValueInput("RVALUE")
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(Blockly.BUDDY_RGB_R);
        this.appendValueInput("GVALUE")
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(Blockly.BUDDY_RGB_G);
        this.appendValueInput("BVALUE")
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(Blockly.BUDDY_RGB_B);
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setTooltip('');
...
Blockly.Blocks.display_4digitdisplay_power = {
    init: function () {
        this.setColour(Blockly.Blocks.display.HUE);
        this.appendDummyInput()
            .appendField(Blockly.BUDDY_4DIGITDISPLAY+"_TM1650")
             .appendField(new Blockly.FieldDropdown([[Blockly.BUDDY_LCD_STAT_ON, "displayOn"], [Blockly.BUDDY_LCD_STAT_OFF, "displayOff"], [Blockly.BUDDY_LCD_STAT_CLEAR, "clear"]]), "STAT");
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
    }
...
//            .setCheck(String)
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(Blockly.BUDDY_4DIGITDISPLAY_DISPLAYSTRING);
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
    }
...
Blockly.Blocks.display_4digitdisplay_showDot = {
    init: function () {
        ...
        this.appendDummyInput()
            .appendField(Blockly.BUDDY_4DIGITDISPLAY + "_TM1650")
            .appendField(Blockly.BUDDY_4DIGITDISPLAY_NOMBER1)
            .appendField(new Blockly.FieldDropdown([["1", "0"], ["2", "1"], ["3", "2"], ["4", "3"]]), "NO")
            .appendField(Blockly.BUDDY_4DIGITDISPLAY_NOMBER2)
            .appendField(Blockly.BUDDY_4DIGITDISPLAY_DOT)
            .appendField(new Blockly.FieldDropdown([[Blockly.BUDDY_4DIGITDISPLAY_ON, "true"], [Blockly.BUDDY_4DIGITDISPLAY_OFF, "false"]]), "STAT");
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
    }
...
Blockly.Blocks.display_TM1637_init = {
    init: function () {
        this.setColour(Blockly.Blocks.display.HUE);
        this.appendValueInput("PIN1").setCheck(Number).setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.BUDDY_4DIGITDISPLAY_TM1637_INIT).appendField("CLK").appendField(Blockly.BUDDY_PIN);
        this.appendValueInput("PIN2").setCheck(Number).setAlign(Blockly.ALIGN_RIGHT).appendField("DIO").appendField(Blockly.BUDDY_PIN);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
          this.setInputsInline(true);
        this.setTooltip(Blockly.BUDDY_4DIGITDISPLAY_TM1637_TIP);
        this.setHelpUrl('');
    }
};
...
Blockly.Blocks.display_TM1637_displayString = {
    init: function () {
        this.setColour(Blockly.Blocks.display.HUE);
        this.appendValueInput("VALUE").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.BUDDY_4DIGITDISPLAY_TM1637_DISPLAYSTRING);
        //this.appendValueInput("Speed").setCheck(Number).setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.BUDDY_4DIGITDISPLAY_SPEED);
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setTooltip(Blockly.BUDDY_4DIGITDISPLAY_TM1637_DISPLAYSTRING_TIP);
    }
};
...
Blockly.Blocks.display_TM1637_displayTime = {
    init: function () {
        this.setColour(Blockly.Blocks.display.HUE);
        this.appendDummyInput("").appendField(Blockly.BUDDY_4DIGITDISPLAY_TM1637_DISPLAYTIME);
        this.appendValueInput("hour").setCheck('Number').setAlign(Blockly.ALIGN_RIGHT);
        this.appendDummyInput("").appendField(Blockly.BUDDY_HOUR);
        this.appendValueInput("minute").setCheck('Number').setAlign(Blockly.ALIGN_RIGHT);
        this.appendDummyInput("").appendField(Blockly.BUDDY_MINUTE);
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setTooltip(Blockly.BUDDY_4DIGITDISPLAY_TM1637_DISPLAYTIME_TOOLTIP);
    }
};
...
Blockly.Blocks.display_TM1637_Stopwatch = {
    init: function () {
        this.setColour(Blockly.Blocks.display.HUE);
        this.appendDummyInput("").appendField(Blockly.BUDDY_4DIGITDISPLAY_STOPWATCH).appendField(new Blockly.FieldDropdown([
          [Blockly.BUDDY_4DIGITDISPLAY_STOPWATCH_START, "stopwatchStart"],
          [Blockly.BUDDY_4DIGITDISPLAY_STOPWATCH_PAUSE, "stopwatchPause"],
          [Blockly.BUDDY_4DIGITDISPLAY_STOPWATCH_RESET, "stopwatchReset"], ]), "STAT");
        this.setTooltip(Blockly.BUDDY_4DIGITDISPLAY_TM1637_STOPWATCH_TOOLTIP);
...
Blockly.Blocks.display_TM1637_Brightness = {
    init: function () {
        this.setColour(Blockly.Blocks.display.HUE);
        this.appendDummyInput("").appendField(Blockly.BUDDY_4DIGITDISPLAY_TM1637_BRIGHTNESS).appendField(new Blockly.FieldDropdown([
          ["7", "7"],
          ["6", "6"],
          ["5", "5"],
          ["4", "4"],
        ...
        this.setTooltip(Blockly.BUDDY_4DIGITDISPLAY_4DIGITDISPLAY_BRIGHTNESS_TOOLTIP);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setInputsInline(true);
    }
...
Blockly.Blocks.display_Matrix_Init = {
  init: function() {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("").appendField(Blockly.BUDDY_DISPLAY_MATRIX_INIT);
...
Blockly.Blocks.display_BDMatrix_Init = {
    init: function() {
      this.setColour(Blockly.Blocks.display.HUE);
      this.appendDummyInput("").appendField(Blockly.BUDDY_DISPLAY_MATRIX_INIT);
      this.appendDummyInput("").setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldTextInput('BD_Matrix'), 'matrixName');
      this.appendValueInput("PIN1").setCheck(Number).setAlign(Blockly.ALIGN_RIGHT).appendField("DIO#");
      this.appendValueInput("PIN2").setCheck(Number).setAlign(Blockly.ALIGN_RIGHT).appendField("CLk#"); 
      this.appendValueInput("PIN3").setCheck(Number).setAlign(Blockly.ALIGN_RIGHT).appendField("LE#"); 
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  //   this.setTooltip("display_点阵屏初始化");
     }
...
Blockly.Blocks.display_Matrix_POS = {
  init: function() {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("").appendField(new Blockly.FieldTextInput('myMatrix'), 'matrixName').appendField(Blockly.BUDDY_DISPLAY_MATRIX_SHOW);
    this.appendValueInput('XVALUE').setCheck('Number').setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.BUDDY_DISPLAY_MATRIX_X);
    this.appendValueInput("YVALUE").setCheck('Number').setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.BUDDY_DISPLAY_MATRIX_Y);
    this.appendDummyInput("").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.BUDDY_DISPLAY_MATRIX_SHOWPOINT).appendField(new Blockly.FieldDropdown(display_DrawPixel_NUM), "DrawPixel_TYPE");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip(Blockly.BUDDY_DISPLAY_MATRIX_SHOWPOINT_TOOLTIP);
  }
};
//执行器_点阵屏显示_旋转变量
...
Blockly.Blocks.display_Matrix_Rotation = {
  init: function() {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("").appendField(new Blockly.FieldTextInput('myMatrix'), 'matrixName').appendField(Blockly.BUDDY_DISPLAY_MATRIX_SHOW);
    this.appendDummyInput("").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.BUDDY_DISPLAY_MATRIX_ROTATE).appendField(new Blockly.FieldDropdown(display_Rotation_NUM), "Rotation_TYPE");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
 //   this.setTooltip("");
  }
...
Blockly.Blocks.display_Matrix_DisplayChar = {
  init: function() {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("").appendField(new Blockly.FieldTextInput('myMatrix'), 'matrixName').appendField(Blockly.BUDDY_DISPLAY_MATRIX_SHOW);
    this.appendValueInput("LEDArray").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.BUDDY_DISPLAY_MATRIX_PICARRAY);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    //this.setTooltip();
  }
...
//执行器_点阵屏显示_显示图案
Blockly.Blocks.display_BDMatrix_DisplayChar = {
    init: function() {
      this.setColour(Blockly.Blocks.display.HUE);
      this.appendDummyInput("").appendField(new Blockly.FieldTextInput('BD_Matrix'), 'matrixName').appendField(Blockly.BUDDY_DISPLAY_MATRIX_SHOW);
      this.appendValueInput("LEDArray").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.BUDDY_DISPLAY_MATRIX_PICARRAY);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      //this.setTooltip();
...
//执行器_点阵屏显示_显示图案_延时
Blockly.Blocks.display_BDMatrix_DisplayChar_Delay = {
    init: function() {
      this.setColour(Blockly.Blocks.display.HUE);
      this.appendDummyInput("").appendField(new Blockly.FieldTextInput('BD_Matrix'), 'matrixName').appendField(Blockly.BUDDY_DISPLAY_MATRIX_SHOW);
      this.appendValueInput("LEDArray").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.BUDDY_DISPLAY_MATRIX_PICARRAY);
      this.appendValueInput("DELAY_TIME").setAlign(Blockly.ALIGN_RIGHT).appendField("DELAY_TIME");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      //this.setTooltip();
    }
...
Blockly.Blocks.display_Matrix_LedArray = {
  init: function() {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("").appendField(Blockly.BUDDY_DISPLAY_MATRIX_ARRAYVAR).appendField(new Blockly.FieldTextInput("LedArray1"), "VAR");
...
Blockly.Blocks.display_Matrix_CLEAR = {
  init: function() {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("").appendField(new Blockly.FieldTextInput('myMatrix'), 'matrixName').appendField(Blockly.BUDDY_DISPLAY_MATRIX_SHOW);
    this.appendDummyInput("").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.BUDDY_DISPLAY_MATRIX_CLEAR);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    //this.setTooltip();
  }

...
Blockly.Blocks.ir_recv = {
    init: function () {
        ...
        this.appendStatementInput('DO')
            .appendField(Blockly.BUDDY_IR_RECEIVE_YES);
        this.appendStatementInput('DO2')
            .appendField(Blockly.BUDDY_IR_RECEIVE_NO);
...
Blockly.Blocks.ir_send_nec = {
    init: function () {
        ...
        this.appendDummyInput("")
			.appendField(Blockly.BUDDY_IR_SEND_NEC1)
			.appendField(new Blockly.FieldDropdown(TYPE), 'TYPE')
			.appendField(Blockly.BUDDY_IR_SEND_NEC2)
        ...
        this.appendValueInput('bits')
			.setCheck('Number')
			.appendField(' ' + Blockly.BUDDY_BITS);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.BUDDY_IR_SEND_NEC_TOOLTIP);
    }
}
...
Blockly.Blocks.ir_recv_enable = {
    init: function () {
        this.setColour(Blockly.Blocks.communicate.HUE);
        this.appendValueInput("PIN", Number)
            .appendField(Blockly.BUDDY_IR_RECEIVE_ENABLE);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setInputsInline(true);
    }
...
Blockly.Blocks.ir_recv_raw = {
    init: function () {
        this.setColour(Blockly.Blocks.communicate.HUE);
        this.appendValueInput("PIN", Number)
            .appendField(Blockly.BUDDY_IR_RECEIVE_RAW)
            .setCheck(Number);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.BUDDY_IR_RECIEVE_RAW_TOOLTIP);
    }
};
...
Blockly.Blocks.ir_send_raw = {
    init: function () {
        this.setColour(Blockly.Blocks.communicate.HUE);
        this.appendDummyInput("")
            .appendField(Blockly.BUDDY_IR_SEND_RAW)
            .appendField(new Blockly.FieldDropdown([["3", "3"]]), "PIN");
        this.appendDummyInput("")
            .appendField(' ' + Blockly.BUDDY_LIST_NAME)
            .appendField(new Blockly.FieldTextInput('0,0,0'), 'TEXT');
        this.appendValueInput('length')
            .setCheck('Number')
            .appendField(' ' + Blockly.BUDDY_LIST_LENGTH);
        this.appendValueInput('freq')
            .setCheck('Number')
            .appendField(' ' + Blockly.BUDDY_FREQUENCY);
        this.setInputsInline(true);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setTooltip(Blockly.BUDDY_IR_SEND_RAW_TOOLTIP);
    }
};
...
Blockly.Blocks.i2c_master_writer = {
    init: function () {
        ...
        this.appendValueInput('device')
            ...
            .appendField(Blockly.BUDDY_I2C_MASTER_WRITE);
        this.appendValueInput('value')
            .setCheck(Number)
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(Blockly.BUDDY_I2C_VALUE);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
    }
};
Blockly.Blocks.i2c_master_reader = {
    init: function () {
        ...
        this.appendValueInput('device')
            .setCheck(Number)
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(Blockly.BUDDY_I2C_MASTER_READ);
        this.appendValueInput('bytes')
            .setCheck(Number)
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(Blockly.BUDDY_I2C_BYTES);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
    }
};
...
Blockly.Blocks.i2c_slave_onreceive = {
    init: function () {
        this.setColour(Blockly.Blocks.communicate.HUE);
        this.appendValueInput("PIN", 'Number')
            .appendField(Blockly.BUDDY_I2C_SLAVE_ONRECEIVE)
            .setCheck(Number);
        this.appendStatementInput('DO')
...
Blockly.Blocks.RFID_init={
    ...
    this.setColour(Blockly.Blocks.communicate.HUE);
	this.appendDummyInput("")
	    .appendField(Blockly.BUDDY_COMMUNICATION_RFID_INITIAL)
		.appendField("SDA")
...
Blockly.Blocks.RFID_on = {
  init: function () {
    this.appendDummyInput("")
      .appendField("RFID")
      .appendField(Blockly.BUDDY_COMMUNICATION_RFID_ON_DETECTED);
...
Blockly.Blocks.RFID_in = {
  init: function () {
    this.appendValueInput("uid_")
      ...
      .appendField(Blockly.BUDDY_COMMUNICATION_RFID_READ_CARDNUM_IS);
    this.appendStatementInput("do_")
...
Blockly.Blocks.RFID_writecarddata={
	...
	this.appendValueInput("address1")
      .appendField(Blockly.BUDDY_COMMUNICATION_RFID_WRITE)
      .appendField(Blockly.BUDDY_COMMUNICATION_DATA_BLOCK)
	this.appendDummyInput("")
      .appendField(Blockly.BUDDY_COMMUNICATION_WRITE_NUM)
	  .appendField(new Blockly.FieldTextInput('mylist'), 'data1')
	this.setPreviousStatement(true);
    this.setNextStatement(true);
	this.setTooltip(Blockly.BUDDY_COMMUNICATION_RFID_TOOLTIP);
  }
};
...
Blockly.Blocks.RFID_readcarddata={
	...
	this.appendValueInput("address")
	    .appendField(Blockly.BUDDY_COMMUNICATION_RFID_READ)
		.appendField(Blockly.BUDDY_COMMUNICATION_DATA_BLOCK)
	this.appendDummyInput("")
		.appendField(Blockly.BUDDY_COMMUNICATION_DATA_FROM)
	this.setOutput(true, Number);
	var thisBlock = this;
...
Blockly.Blocks.RFID_off={
    ...
    this.setColour(Blockly.Blocks.communicate.HUE);
	this.appendDummyInput("")
	    .appendField(Blockly.BUDDY_COMMUNICATION_RFID_OFF)
	//this.setOutput(true, Number);
	this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
	var thisBlock = this;

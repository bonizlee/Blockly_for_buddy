...
Blockly.Arduino.display_BDMatrix_Init = function() {
  var DIO = Blockly.Arduino.valueToCode(this, 'PIN1', Blockly.Arduino.ORDER_ATOMIC);
  var CLK = Blockly.Arduino.valueToCode(this, 'PIN2', Blockly.Arduino.ORDER_ATOMIC);
  var LE = Blockly.Arduino.valueToCode(this, 'PIN3', Blockly.Arduino.ORDER_ATOMIC);
  var matrixName = this.getFieldValue('matrixName');
  Blockly.Arduino.definitions_['include_BDMatrix'] = '#include<BD.h> \n#include<BD_LEDMatrix.h> ';
  Blockly.Arduino.definitions_[matrixName] = 'BD_LEDMatrix '+ matrixName +';';
  Blockly.Arduino.setups_['setup_' + matrixName] = matrixName + '.Init('+DIO+','+CLK+','+LE+'); \n';
  //var code= matrixName+'.clear();\n';
  return '';
};
...
//执行器_点阵屏显示_显示图案BD
Blockly.Arduino.display_BDMatrix_DisplayChar = function() {
  var matrixName = this.getFieldValue('matrixName');
  var dotMatrixArray = Blockly.Arduino.valueToCode(this, 'LEDArray', Blockly.Arduino.ORDER_ASSIGNMENT);
  var code= matrixName+'.Display('+dotMatrixArray+');\n'
  return code;
};

//执行器_点阵屏显示_显示图案BD delay
Blockly.Arduino.display_BDMatrix_DisplayChar_Delay = function() {
  var matrixName = this.getFieldValue('matrixName');
  var delaytime = Blockly.Arduino.valueToCode(this, 'DELAY_TIME', Blockly.Arduino.ORDER_ATOMIC);
  var dotMatrixArray = Blockly.Arduino.valueToCode(this, 'LEDArray', Blockly.Arduino.ORDER_ASSIGNMENT);
  var code= matrixName+'.Display('+dotMatrixArray+','+delaytime+');\n'
  return code;
};
